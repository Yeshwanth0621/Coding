...
export const EVENT_CARDS: EventCard[] = [
  {
    ...
    effect: 'Manual apply: No new trades this round; Quick Edit -> Manufacturing -3 for affected countries.',
    severity: 'critical',
  },
  {
    id: 'financial_crisis',
    ...
    effect: 'Manual apply: Quick Edit -> GC -30 and Finance -2 for affected countries.',
    severity: 'high',
  },
  {
    id: 'drought',
    ...
    effect: 'Manual apply: Quick Edit -> Food -3 and Energy -1 for affected countries.',
    severity: 'high',
  },
  {
    id: 'tech_boom',
    ...
    effect: 'Manual apply: Quick Edit -> Technology +3 and Finance +1 for affected countries.',
    severity: 'low',
  },
  {
    id: 'climate_disaster',
    ...
    effect: 'Manual apply: Quick Edit -> Energy -2 and Manufacturing -2 for affected countries.',
    severity: 'critical',
  },
  {
    id: 'conflict',
    ...
    effect: 'Manual apply: Quick Edit -> Manpower -5 and GC -20 for affected countries.',
    severity: 'high',
  },
  {
    id: 'trade_boom',
    ...
    effect: 'Manual apply: Quick Edit -> GC +20 and +2 to all resources for affected countries.',
    severity: 'low',
  },
];
