...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class SupabaseLibraryAccessors extends SubDependencyFactory {
        private final SupabaseComposeLibraryAccessors laccForSupabaseComposeLibraryAccessors = new SupabaseComposeLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>supabase.compose</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public SupabaseComposeLibraryAccessors getCompose() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForSupabaseComposeLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class SupabaseComposeLibraryAccessors extends SubDependencyFactory {
        private final SupabaseComposeAuthLibraryAccessors laccForSupabaseComposeAuthLibraryAccessors = new SupabaseComposeAuthLibraryAccessors(owner);

        public SupabaseComposeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>supabase.compose.auth</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public SupabaseComposeAuthLibraryAccessors getAuth() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForSupabaseComposeAuthLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class SupabaseComposeAuthLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public SupabaseComposeAuthLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> asProvider() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("supabase.compose.auth");
        }
        ...
        public Provider<MinimalExternalModuleDependency> getUi() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("supabase.compose.auth.ui");
        }
